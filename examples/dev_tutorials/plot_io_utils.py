...
################################################################################################
# Among the many best-practices we follow when developing a new Process or Fitter class is memory-safe computation.
# This handy function helps us quickly get the available memory
print('Available memory in this machine: {} GB'.format(px.io_utils.get_available_memory()/1024**3))

################################################################################################
# Frequently, there is a need to print out logs on the console to inform the user about the size of files etc.
# format_quantity is a handy function that helps in printing out such quantities.
