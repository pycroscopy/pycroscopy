...
h5_spec_vals = px.core.io.hdf_utils.get_auxillary_datasets(h5_main, 'Spectroscopic_Values')[0]
...
ds_labels_spec_inds, ds_labels_spec_vals = px.build_ind_val_dsets([1], labels=['Label'])
ds_cluster_inds, ds_cluster_vals = px.build_ind_val_dsets([centroids.shape[0]], is_spectral=False,
                                                                                     labels=['Cluster'])
...
h5_spec_inds = px.core.io.hdf_utils.get_auxillary_datasets(h5_main, 'Spectroscopic_Indices')[0]
