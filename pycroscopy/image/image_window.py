...
class ImageWindowing:
    ...
    def MakeWindows(self, dataset, dim_slice=None):
        ...
        assert self.image_shape[0]%self.window_step_x ==0, "Image shape {} and window step along x ({}) are not divisible \
        without remainder, change your image shape or window step".format(self.image_shape[0], self.window_step_x)
        assert self.image_shape[1]%self.window_step_y ==0, "Image shape {} and window step along y ({}) are not divisible \
        without remainder, change your image shape or window step".format(self.image_shape[1], self.window_step_y)
