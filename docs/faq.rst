...
Pycroscopy Ecosystem Philosophy
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Is pycroscopy only for the scientific imaging and material science communities?
-------------------------------------------------------------------------------
**Not at all**. We have ensured that the basic data and file formatting paradigm is general enough
that it can be extended to any other scientific domain so long as each experiment involves ``N`` identical measurements of ``S`` values.
