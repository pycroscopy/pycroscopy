...
ds_labels_spec_inds, ds_labels_spec_vals = pycroscopy.core.io.hdf_utils.build_ind_val_dsets([1], labels=['Label'])
ds_cluster_inds, ds_cluster_vals = pycroscopy.core.io.hdf_utils.build_ind_val_dsets([centroids.shape[0]], is_spectral=False,
                                                                                    labels=['Cluster'])
