...
3. Python 3 support
-------------------
h5py is central to all I/O operations in pycroscopy. Unfortunately, h5py is not able to handle single character strings elegantly in python 3. Pycroscopy will become python 3 compatible once this issue in h5py is fixed.
